...
export default function IOSH() {
    ...
    const fetchCourses = async () => {
        try {
            ...
            // Filter only IOSH courses
            const ioshCourses = allCourses.filter(course =>
                course.category === 'IOSH' || course.category === 'iosh'
            );
            setCourses(ioshCourses);
        } catch (error) {
        ...
        <div className="min-h-screen bg-gray-50 py-10 px-4">
            ...
            <div className="text-center mb-10">
                ...
                <p className="text-gray-600 max-w-2xl mx-auto">
                    Institution of Occupational Safety and Health - World's Leading Health & Safety Organization
                </p>
            ...
            <div className="max-w-7xl mx-auto">
                {courses.length === 0 ? (
                    <div className="text-center py-12 bg-white rounded-xl shadow-lg">
                        <div className="text-4xl mb-4">📭</div>
                        <p className="text-gray-500">No IOSH courses available yet.</p>
                    </div>
                ) : (
