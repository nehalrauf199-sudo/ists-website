...
// Category page showing all sub-courses with images
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-7xl mx-auto px-4 py-8">
                            ...
                            >
                                <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-300 border-2 border-transparent hover:border-orange-500 h-full">
                                    ...
                                    {course.image ? (
                                        ...
                                        <div className="h-56 bg-gradient-to-r from-blue-100 to-orange-100 flex items-center justify-center">
                                    ...
                                    {/* Course Content */}
                                    <div className="p-6">
                                        <h3 className="text-xl font-bold text-blue-900 mb-2 group-hover:text-orange-600 transition line-clamp-2">
                                            {course.name}
                                        </h3>
                                        <p className="text-sm text-gray-500 mb-3">
                                            Duration: <span className="font-semibold text-blue-700">{course.duration}</span>
                                        </p>
                                        <div className="flex items-center justify-between">
                                            <span className="text-sm text-gray-600 group-hover:text-orange-600 transition">
                                                View Details →
                                            </span>
                                        </div>
                                    </div>
                ...
                <div className="mt-8 text-center">
                    <Link
                        href="/courses"
                        className="inline-flex items-center gap-2 text-blue-600 hover:text-orange-600 transition font-semibold"
                    >
                        <svg
                            className="w-5 h-5"
                            fill="none"
